...
public:
	...
	virtual UlError checkScanState(bool* scanDone = NULL) const { return ERR_BAD_DEV_TYPE;}
        ...
        virtual void updateScanParam(int param)  =0;
        virtual void processScanData(void* transfer) =0;
        virtual unsigned int processScanData(void* transfer, unsigned int stageSize) =0;
